      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="card-elevated animate-fade-in-up opacity-0 stagger-1">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-body-sm font-medium">Total Users</p>
              </div>
            ...
            <div className="card-elevated animate-fade-in-up opacity-0 stagger-2">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-body-sm font-medium">Pending Verifications</p>
              </div>
            ...
            <div className="card-elevated animate-fade-in-up opacity-0 stagger-3">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-body-sm font-medium">Active Requests</p>
              </div>
            ...
            <div className="card-elevated animate-fade-in-up opacity-0 stagger-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-body-sm font-medium">Open Reports</p>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12">
          ...
          >
            ...
            <div>
              <p className="font-body text-sm font-semibold text-forest-800">Verification Queue</p>
          ...
          >
            ...
            <div>
              <p className="font-body text-sm font-semibold text-forest-800">User Management</p>
              <p className="text-body-sm">Manage brokers</p>
            </div>
          </Link>
          <Link
            href="/admin/reports"
          ...
          >
            ...
            <div>
              <p className="font-body text-sm font-semibold text-forest-800">Reports</p>
              <p className="text-body-sm">
                {stats?.openReports ?? 0} open
              </p>
            </div>
          </Link>
        </div>
