                      ...
                      <div className="rounded-lg bg-cream-50 p-4 space-y-3">
                        ...
                        {details.annualIncome && typeof details.annualIncome === "object" && (
                          <div className="col-span-3">
                            <p className="label-text mb-2">{t("request.annualIncome", "Annual Income")}</p>
                            <table className="w-full text-sm">
                              <thead>
                                <tr className="border-b border-cream-200">
                                  <th className="font-body font-medium text-sage-500 text-left py-1.5 pr-4">{t("request.selectYear", "Year")}</th>
                                  <th className="font-body font-medium text-sage-500 text-right py-1.5">{t("request.annualIncome", "Annual Income")}</th>
                                </tr>
                              </thead>
                              <tbody>
                      ...
                      <div className="rounded-lg bg-cream-50 p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          {(details.corporateAnnualIncome != null || details.corporateAnnualExpenses != null) && (
                            <div className="col-span-3">
                              <p className="label-text mb-2">{t("request.corporateFinancials", "Corporate Financials")}</p>
                              {typeof details.corporateAnnualIncome === "object" ? (
                                <table className="w-full text-sm">
                                  <thead>
                                    <tr className="border-b border-cream-200">
                                      <th className="font-body font-medium text-sage-500 text-left py-1.5 pr-4">{t("request.selectYear", "Year")}</th>
                                      <th className="font-body font-medium text-sage-500 text-right py-1.5 px-4">{t("request.corpIncome", "Income")}</th>
                                      <th className="font-body font-medium text-sage-500 text-right py-1.5 pl-4">{t("request.corpExpenses", "Expenses")}</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                  <div>
                                    <p className="font-body text-xs text-sage-500">{t("request.corpIncome", "Income")}</p>
                                    <p className="font-body text-sm text-forest-800">${String(details.corporateAnnualIncome)}</p>
                                  </div>
                                  <div>
                                    <p className="font-body text-xs text-sage-500">{t("request.corpExpenses", "Expenses")}</p>
