      ...
      <div className="mt-5 flex items-center justify-between border-t border-cream-200 pt-4">
        <div className="flex items-center gap-4 font-body text-xs text-sage-400">
          ...
          <span className="flex items-center gap-1">
            ...
            {request._count.conversations}{" "}
            {request._count.conversations === 1 ? t("borrowerDashboard.response", "response") : t("borrowerDashboard.responsesPlural", "responses")}
          </span>
        </div>
        <Link
        ...
        >
          {t("borrowerDashboard.viewDetails")} &rarr;
        </Link>
      </div>
    </div>
  );
